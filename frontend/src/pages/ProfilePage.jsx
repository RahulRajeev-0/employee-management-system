  ...
  <Navbar/>
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <div className="bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        {/* Status message */}
        {message.text && (
          <div className={`px-6 py-3 ${message.type === 'success' ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'} flex items-center`}>
            {message.type === 'success' ? <FiCheckCircle className="mr-2" /> : null}
            {message.text}
          </div>
        )}
            ...
            <div className="relative">
              <div className="w-32 h-32 rounded-full overflow-hidden bg-gray-200 flex items-center justify-center border-4 border-white shadow">
                {formData.profilePicture ? (
                  <img 
                  src={baseURL + formData.profilePicture} 
                    alt="Profile" 
              ...
              {!isEditing && (
                <>
                  <p className="text-gray-600 flex items-center gap-2 mt-2">
                    <FiUser className="text-blue-500" /> @{user?.username || ''}
                  </p>
